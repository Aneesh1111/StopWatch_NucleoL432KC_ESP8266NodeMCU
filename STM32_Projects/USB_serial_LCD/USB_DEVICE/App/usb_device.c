...
/* USER CODE BEGIN 0 */
/*
 * From: https://electricui.com/blog/clion-stm32-setup#setting-up-usb-cdc
 */
//space for 32 chars + cr + lf + empty space so that a full 32 character message will not wrap around
